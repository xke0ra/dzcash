...
@Injectable()
export class MonetagProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'Monetag';
  protected readonly baseUrl = 'https://monetag.com';
  private readonly secret = process.env.MONETAG_SECRET || 'monetag-dev-secret';
