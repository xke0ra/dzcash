...
@Injectable()
export class TimeWallProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'TimeWall';
  protected readonly baseUrl = 'https://timewall.com';
  private readonly secret = process.env.TIMEWALL_SECRET || 'timewall-dev-secret';
