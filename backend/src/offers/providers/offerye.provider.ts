...
@Injectable()
export class OfferYeProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'OfferYe';
  protected readonly baseUrl = 'https://offerye.com';
  private readonly secret = process.env.OFFERYE_SECRET || 'offerye-dev-secret';
