...
@Injectable()
export class AdWorksHubProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'AdWorksHub';
  protected readonly baseUrl = 'https://adworkshub.com';
  private readonly secret = process.env.ADWORKSHUB_SECRET || 'adworkshub-dev-secret';
