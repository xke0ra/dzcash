...
@Injectable()
export class OfferFloodProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'OfferFlood';
  protected readonly baseUrl = 'https://offerflood.com';
  private readonly secret = process.env.OFFERFLOOD_SECRET || 'offerflood-dev-secret';
