...
@Injectable()
export class PersonaProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'Persona';
  protected readonly baseUrl = 'https://persona.com';
  private readonly secret = process.env.PERSONA_SECRET || 'persona-dev-secret';
