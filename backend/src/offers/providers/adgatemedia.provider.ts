...
@Injectable()
export class AdgateMediaProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'AdgateMedia';
  protected readonly baseUrl = 'https://adgatemedia.com';
  private readonly secret = process.env.ADGATE_MEDIA_SECRET || 'adgate-dev-secret';
