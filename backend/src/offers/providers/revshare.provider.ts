...
@Injectable()
export class RevShareProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'RevShare';
  protected readonly baseUrl = 'https://revshare.com';
  private readonly secret = process.env.REVSHARE_SECRET || 'revshare-dev-secret';
