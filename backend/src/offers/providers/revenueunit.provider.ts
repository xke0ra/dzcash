...
@Injectable()
export class RevenueUnitProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'RevenueUnit';
  protected readonly baseUrl = 'https://revenueunit.com';
  private readonly secret = process.env.REVENUEUNIT_SECRET || 'revenueunit-dev-secret';
  ...
  async syncOffers(): Promise<SyncOffer[]> {
    return this.generateMockOffers(4);
  }
}
