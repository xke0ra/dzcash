...
@Injectable()
export class AdWallProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'AdWall';
  protected readonly baseUrl = 'https://adwall.com';
  private readonly secret = process.env.ADWALL_SECRET || 'adwall-dev-secret';
