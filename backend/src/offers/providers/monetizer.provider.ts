...
@Injectable()
export class MonetizerProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'Monetizer';
  protected readonly baseUrl = 'https://monetizer.com';
  private readonly secret = process.env.MONETIZER_SECRET || 'monetizer-dev-secret';
