...
@Injectable()
export class KiwiWallProvider extends BaseProvider implements OfferProviderInterface {
  protected readonly providerName = 'KiwiWall';
  protected readonly baseUrl = 'https://kiwiwall.com';
  private readonly secret = process.env.KIWIWALL_SECRET || 'kiwiwall-dev-secret';
