            ...
            <tbody className="divide-y divide-slate-800/50">
              {isLoading ? (
                ...
                <tr key={u.id} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="p-4">
                    <div className="text-slate-200 font-medium">${parseFloat(u.wallet?.availableBalance || '0').toFixed(2)}</div>
                    <div className="text-[10px] text-slate-500">{parseFloat(u.wallet?.pendingBalance || '0').toFixed(2)} pending</div>
                  </td>
                  <td className="p-4 font-medium text-emerald-400">${parseFloat(u.totalEarned || '0').toFixed(2)}</td>
