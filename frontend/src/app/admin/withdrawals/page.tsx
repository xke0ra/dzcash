            ...
            <tbody className="divide-y divide-slate-800/50">
              {isLoading ? (
                ...
                <tr key={w.id} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="p-4 font-extrabold text-rose-400">${parseFloat(w.amount).toFixed(2)}</td>
                  <td className="p-4 text-slate-400">${parseFloat(w.fee || '0').toFixed(2)}</td>
                  <td className="p-4 font-bold text-slate-200">${(parseFloat(w.amount) - parseFloat(w.fee || '0')).toFixed(2)}</td>
