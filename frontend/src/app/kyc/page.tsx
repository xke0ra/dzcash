    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      {step === 'upload-front' && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex justify-between">
            <button onClick={() => setStep('id-type')} className="text-sm text-slate-400 hover:text-white transition-colors">Back</button>
            <button
      ...
      {step === 'upload-back' && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex justify-between">
            <button onClick={() => setStep('upload-front')} className="text-sm text-slate-400 hover:text-white transition-colors">Back</button>
            <button
      ...
      {step === 'selfie' && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex justify-between">
            <button onClick={() => setStep('upload-back')} className="text-sm text-slate-400 hover:text-white transition-colors">Back</button>
            <button
      ...
      {step === 'review' && (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex justify-between">
            <button onClick={() => setStep('selfie')} className="text-sm text-slate-400 hover:text-white transition-colors">Back</button>
            <button
